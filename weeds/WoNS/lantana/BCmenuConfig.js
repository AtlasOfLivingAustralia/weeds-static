...
["Lanatana resource order form", "resources.htm#lrof", ""],
["Using Herbicides on Lantana", "resources.htm#uhol", ""],
["Battling Lantana: learning from the experiences of others (DVD)", "resources.htm#bl", ""],
["Fact Sheets – <i>Lantana camara</i>", "resources.htm#fs", ""],
["Flower Guide (available by download only)", "resources.htm#fg", ""],
["Lantana Poisoning Brochure", "resources.htm#lpb", ""],
["Biological Control Fact Sheets", "resources.htm#bcfs", ""],
["Promotional Posters", "resources.htm#posters", ""],
["Free Australia from Lantana Brochure", "resources.htm#fafl", ""],
["Surveys and Reports (available by download only)", "resources.htm#sr", ""],
["Information Sheets (available by download only)", "resources.htm#is", ""],
["Lantana Lowdown archive", "resources.htm#ll", ""]
]};
make_menus();